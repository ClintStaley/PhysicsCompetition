/*
   ...
   Source: https://github.com/felixmariotto/three-mesh-ui/blob/master/examples/utils/VRControl.js
*/
...
export default function VRControl( renderer ) {
   ...
   // Should be called after raycaster.intersectObject() found an intersection 
   // point.
