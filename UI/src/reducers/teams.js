   ...
   switch (action.type) {
      ...
      case 'TOGGLE_TEAM':
         ...
         if (Object.keys(state[action.memberData.teamId].members).length  === 0){
            return Object.assign({}, state, {[teamId]: Object.assign({}, state[teamId], {toggled:  !state[teamId].toggled}, {members: members})})
            //update(update(state, {[teamId]:{members:{$set :members}}}), {[teamId]:{toggled:{$set :!state[teamId].toggled}}});
         }
         return Object.assign({}, state, {[teamId]: Object.assign({}, state[teamId], {toggled: !state[teamId].toggled})});
      ...
      //will add member data to the object
         return Object.assign({}, state, {members: action.memberdata.members});//update(state, {[action.memberData.teamId]:{members:{$set :action.memberData.members}}});
      case 'DELETE_TEAM':
