...
insert into Person (firstName, lastName, email,       password,   whenRegistered, role)
            VALUES ("Emma", "Lopez", "admin@softwareinventions.com", "5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8", NOW(), 1);
...
insert into Competition (title, ctpId, ownerId, description, prms)
            VALUES ('Bounce Challenge 1', 2, 1, 'A somewhat challenging competition, this one can be done with one ball.', '{"targetTime": 5.1505, "targets": [ { "loX": 1.4, "hiX": 2.4, "hiY": 7.4, "loY": 7.1 }, { "loX": 4.0, "hiX": 5.5, "hiY": 3.9, "loY": 3.6 }, { "loX": 7.6, "hiX": 9.0, "hiY": 5.5, "loY": 5.2 }], "barriers": [ { "loX": 6.4, "hiX": 7, "hiY": 9, "loY": 3 }] }');
